...
post_patch() {
  ...
  elif [ -f $ROOT/.openelec/projects/$PROJECT/$PKG_NAME/$PKG_NAME.$TARGET_ARCH.conf ]; then
    KERNEL_CFG_FILE=$ROOT/.openelec/projects/$PROJECT/$PKG_NAME/$PKG_NAME.$TARGET_ARCH.conf
  else
