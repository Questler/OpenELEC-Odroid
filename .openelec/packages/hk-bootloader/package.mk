...
case $PROJECT in
  Odroid-U2)  PKG_VERSION="33e05ff" ; DEVICE=U2  ;;
  Odroid-XU3) PKG_VERSION="3acd50c" ; DEVICE=XU3 ;;
  Odroid-C1)  PKG_VERSION="c878e20" ; DEVICE=C1  ;;
  Odroid-C2)  PKG_VERSION="5785ef8" ; DEVICE=C2  ;;
esac
PKG_REV="1"
PKG_ARCH="any"
PKG_LICENSE="other"
